...
import static com.mryqr.core.common.domain.event.publish.DomainEventPublishStatus.*;
import static com.mryqr.core.common.domain.event.publish.PublishingDomainEvent.Fields.*;
